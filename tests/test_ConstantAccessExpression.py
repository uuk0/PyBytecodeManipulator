...
class TestParsing(TestCase):
    def test_parse_string(self):
        ...
        self.assertEqual(
            expr, CompoundExpression([LoadAssembly(ConstantAccessExpression("test"))])
        )
    ...
    def test_parse_int(self):
        ...
        self.assertEqual(
            expr, CompoundExpression([LoadAssembly(ConstantAccessExpression(10))])
        )
    ...
    def test_parse_none(self):
        ...
        self.assertEqual(
            expr, CompoundExpression([LoadAssembly(ConstantAccessExpression(None))])
        )
    ...
    def test_parse_false(self):
        ...
        self.assertEqual(
            expr, CompoundExpression([LoadAssembly(ConstantAccessExpression(False))])
        )
    ...
    def test_parse_true(self):
        ...
        self.assertEqual(
            expr, CompoundExpression([LoadAssembly(ConstantAccessExpression(True))])
        )
