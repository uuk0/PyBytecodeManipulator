...
from bytecodemanipulation.assembler.AbstractBase import ParsingScope, AbstractSourceExpression
...
class AbstractAssertAssembly(AbstractAssemblyInstruction, ABC):
    ...
    def __init__(self, source: AbstractSourceExpression, text: AbstractSourceExpression = None):
        self.source = source
        self.text = text
    ...
    def __eq__(self, other):
        return type(self) == type(other) and self.source == other.source and self.text == other.text
